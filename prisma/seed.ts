...
async function main() {
  ...
  const listings = [
    ...
    {
      listingId: "AE-2026-0005",
      title: "Alsancak'ta Lüks Tasarımlı Deniz Manzaralı Satılık Villa",
      kind: "SATILIK",
      propertyType: "Villa",
      city: "Girne",
      region: "Alsancak",
      price: 850000,
      currency: "EUR",
      shortDescription: "Akıllı ev sistemi, müstakil havuz ve geniş bahçe imkanıyla full eşyalı lüks yaşam.",
      longDescription: "<p>Bu harika villa size eşsiz bir yaşam sunuyor. Geniş teraslar ve modern tasarım ile konforun tadını çıkarın.</p>",
    ...
    },
    {
      ...
      price: 850,
      currency: "EUR",
      shortDescription: "Ulaşım ağlarına çok yakın, güvenlikli site içerisinde modern tasarımlı 1+1 daire.",
      longDescription: "<p>Şehrin tam merkezinde yer alan bu rezidans, asansörlü ve kapalı otoparklıdır.</p>",
      coverImage: unsplash("photo-1522708323590-d24dbb6b0267"),
      bedrooms: 1,
      bathrooms: 1,
      areaM2: 65,
